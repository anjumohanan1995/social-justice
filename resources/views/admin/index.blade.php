                  ...
                  <div class="col-md-12 col-sm-6"> 
                    <div class="card boost-up-card overflow-hidden">
                      <div class="p-4">
                        ...
                        <div class="img-boostup"><img class="img-boostup-img-1" src="{{ asset('admin/images/boostup1.png')}}" alt="boostup"><img class="img-boostup-img-2" src="{{ asset('admin/images/boostup2.png')}}" alt="boostup"></div>
                    ...
                    <div class="top-product-card">
                      <ul>
                        <li class="d-flex top-product gap-2">
                          <div><img class="img-fluid product-img" src="{{ asset('admin/images/1.png')}}" alt="product"/></div>
                        ...
                        <li class="d-flex top-product gap-2">
                          <div><img class="img-fluid product-img" src="{{ asset('admin/images/2.png')}}" alt="product"/></div>
                          <div class="w-100 d-flex justify-content-between align-items-center">
                            <div class="product-details">
                        ...
                        <li class="d-flex top-product gap-2">
                          <div><img class="img-fluid product-img" src="{{ asset('admin/images/3.png')}}" alt="product"/></div>
                          <div class="w-100 d-flex justify-content-between align-items-center">
                            <div class="product-details">
                        ...
                        <li class="d-flex top-product gap-2">
                          <div><img class="img-fluid product-img" src="{{ asset('admin/images/4.png')}}" alt="product"/></div>
                          <div class="w-100 d-flex justify-content-between align-items-center">
                            <div class="product-details">
                ...
                <div class="card height-equal">
                  ...
                  <div class="card-body pt-0"> 
                    <div class="new-user"> 
                      <ul> 
                        <li>
                          <div class="space-common d-flex user-name"><img class="img-40 rounded-circle img-fluid me-2" src="{{ asset('admin/images/22.png')}}" alt="user"/>
                        ...
                        <li>
                          <div class="space-common d-flex user-name"><img class="img-40 rounded-circle img-fluid me-2" src="{{ asset('admin/images/28.png')}}" alt="user"/>
                            <div class="common-space w-100">
                              <div>
                        ...
                        <li>
                          <div class="space-common d-flex user-name"><img class="img-40 rounded-circle img-fluid me-2" src="{{ asset('admin/images/26.png')}}" alt="user"/>
                            <div class="common-space w-100">
                              <div>
                        ...
                        <li>
                          <div class="space-common d-flex user-name"><img class="img-40 rounded-circle img-fluid me-2" src="{{ asset('admin/images/24.png')}}" alt="user"/>
                            <div class="common-space w-100">
                              <div>
                        ...
                        <li>
                          <div class="space-common d-flex user-name"><img class="img-40 rounded-circle img-fluid me-2" src="{{ asset('admin/images/49.png')}}" alt="user"/>
                            <div class="common-space w-100">
                              <div>
                              ...
                              <div class="team-activity">
                                <div class="activity-data d-flex align-items-center gap-3">
                                  <div class="common-space gap-2 "> 
                                    <div class="user-activity me-3"><img class="rounded-circle p-1 img-fluid me-3 img-50" src="{{ asset('admin/images/50.png')}}" alt="user"><a class="f-10 f-w-500 username" href="edit-profile.html">Floyd Miles</a></div>
                          ...
                          <tr>
                            <td>
                              <div class="team-activity">
                                <div class="activity-data d-flex align-items-center gap-3">
                                  <div class="common-space gap-2 "> 
                                    <div class="user-activity me-3"><img class="rounded-circle p-1 img-fluid me-3 img-50" src="{{ asset('admin/images/51.png')}}" alt="user"><a class="f-10 f-w-500 username" href="edit-profile.html">Ralph Edwards</a></div>
                          ...
                          <tr>
                            <td>
                              <div class="team-activity">
                                <div class="activity-data d-flex align-items-center gap-3">
                                  <div class="common-space gap-2 "> 
                                    <div class="user-activity me-3"><img class="rounded-circle p-1 img-fluid me-3 img-50" src="{{ asset('admin/images/33.png')}}" alt="user"><a class="f-10 f-w-500 username" href="edit-profile.html">Esther Howard</a></div>
                          ...
                          <tr>
                            <td>
                              <div class="team-activity">
                                <div class="activity-data d-flex align-items-center gap-3">
                                  <div class="common-space gap-2 "> 
                                    <div class="user-activity me-3"><img class="rounded-circle p-1 img-fluid me-3 img-50" src="{{ asset('admin/images/52.png')}}" alt="user"><a class="f-10 f-w-500 username" href="edit-profile.html">Jacob Jones</a></div>
                          ...
                          <tr>
                            <td>
                              <div class="team-activity">
                                <div class="activity-data d-flex align-items-center gap-3">
                                  <div class="common-space gap-2 "> 
                                    <div class="user-activity me-3"><img class="rounded-circle p-1 img-fluid me-3 img-50" src="{{ asset('admin/images/53.png')}}" alt="user"><a class="f-10 f-w-500 username" href="edit-profile.html">Theresa Webb</a></div>
                          ...
                          <tr>
                            <td>
                              <div class="team-activity">
                                <div class="activity-data d-flex align-items-center gap-3">
                                  <div class="common-space gap-2 "> 
                                    <div class="user-activity me-3"><img class="rounded-circle p-1 img-fluid me-3 img-50" src="{{ asset('admin/images/54.png')}}" alt="user"><a class="f-10 f-w-500 username" href="edit-profile.html">Annette Black</a></div>
                                    <div class="activity-time"><span class="f-light f-w-500 f-10">12 min ago</span></div>
                                  </div>
                                  <div class="subtitle"> 
