            ...
            <div class="page-title">
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <li class="breadcrumb-item active"> Add Panchayat</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('panchayat.store') }}" method="POST" class="row g-3 needs-validation custom-input">
                          @csrf
                          <div class="col-md-6 position-relative">
                            ...
                            <div class="col-md-6 position-relative">
                                <label class="form-label" for="validationTooltip01"> Name</label>
                                    <input type="text" id="name" name="name" class="form-control" placeholder="Enter panchayat name" value="{{ old('name') }}" required>
                                    @error('name')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                            </div>
