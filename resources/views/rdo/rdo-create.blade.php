            ...
            <div class="page-title">
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <li class="breadcrumb-item active"> Add RDO Name</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('rdo.store') }}" method="POST" class="row g-3 needs-validation custom-input">
                                    @csrf
                            ...
                            <div class="col-md-4 position-relative">
                                <label class="form-label" for="validationTooltip01"> Name</label>
                                    <input type="text" id="name" name="name" class="form-control" placeholder="Enter RDO name" value="{{ old('name') }}" required>
                                    @error('name')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                            </div>
                            <div class="col-md-4 position-relative">
                                ...
                                <select id="district" name="status" class="form-control" value="{{ old('district') }}" required>
